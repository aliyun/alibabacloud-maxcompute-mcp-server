...
class TestCredentialClientFunction:
    ...
    def test_import_error_raises_value_error(self):
        ...
        with (
            ...
            pytest.raises(ValueError, match="alibabacloud-credentials is required"),
        ):
...
class TestMaxComputeCatalogSdkRefresh:
    ...
    def test_build_uses_credential_field_when_client_provided(self):
        ...
        catalog_client = _build_catalog_client(
            "catalogapi.example.com", credential_client=mock_cred_client
        )
    ...
    def test_create_with_credential_client_passes_to_build(self):
        ...
        with patch(
            "maxcompute_catalog_mcp.maxcompute_client._build_catalog_client",
    ...
    def test_uses_credential_provider_account_when_client_provided(self):
        ...
        try:
            ...
            result = MaxComputeClient.create(
                cfg, credential_client=mock_credential_client
            )
...
class TestCredentialsAutoRefreshE2E:
    ...
    def test_tea_sdk_holds_credential_client_reference(self):
        ...
        with (
            patch.object(auth_util, "environment_credentials_uri", uri),
    ...
    def test_catalog_sdk_create_with_credentials_uri(self):
        ...
        with (
            ...
            with patch(
                "maxcompute_catalog_mcp.maxcompute_client._build_catalog_client",
                return_value=mock_catalog_client,
            ) as mock_build:
            ...
            assert "access_key_id" not in call_kwargs.kwargs or call_kwargs.kwargs.get(
                "access_key_id"
            ) in (None, ""), "credential_client path should not pass static ak"
