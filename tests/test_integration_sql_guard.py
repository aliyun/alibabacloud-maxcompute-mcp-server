...
class TestExecuteSqlGuardBypass:
    ...
    def test_with_insert_bypass(
        ...
        assert p.get("success") is False, (
            f"WITH ... INSERT should be rejected, but got: {p}"
        )
    ...
    def test_with_delete_bypass(
        ...
        p = _text_payload(r)
        assert p.get("success") is False, (
            f"WITH ... DELETE should be rejected, but got: {p}"
        )
    ...
    def test_with_update_bypass(
        ...
        p = _text_payload(r)
        assert p.get("success") is False, (
            f"WITH ... UPDATE should be rejected, but got: {p}"
        )
    ...
    def test_with_merge_bypass(
        ...
        p = _text_payload(r)
        assert p.get("success") is False, (
            f"WITH ... MERGE should be rejected, but got: {p}"
        )
    ...
    def test_plain_insert_rejected(
        self, real_tools: Tools, real_config: Any, created_tables: list[str]
    ) -> None:
    ...
    def test_multi_stmt_insert_rejected(
        self, real_tools: Tools, real_config: Any, created_tables: list[str]
    ) -> None:
